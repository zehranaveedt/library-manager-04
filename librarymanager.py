        ...
        with st.form(key='add_book_form'):
            ...
            if st.session_state.book_removed:
                ...
                if hasattr(st.session_state, 'search_results'):
                    ...
                    st.markdown("---")
                    st.markdown("Copyright @ 2025 Zahra Naveed Personal Library Manager", unsafe_allow_html=True)mera code run nh horha
ChatGPT said:
Aapka Streamlit app ek Personal Library Management System hai jo users ko apni kitaabon ka record rakhne, search karne, aur statistics dekhne ki sahulat deta hai. Yeh kaafi interactive aur visually appealing hai, especially Plotly visualizations aur custom CSS styling ki wajah se.

Agar aap kisi specific issue ya improvement par kaam kar rahe hain, toh bataiye! Kya aap koi bug face kar rahe hain, koi feature add karna chahte hain, ya UI enhance karna chahte hain? 😊
